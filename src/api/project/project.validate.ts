...
export const validateCreateProject = (project: Project): { error: Joi.ValidationError; value: Project } => {
...
export const validateProjectQuery = (project: Project): { error: Joi.ValidationError; value: Project } => {
...
export const validateUpdateProject = (project: Project): { error: Joi.ValidationError; value: Project } => {
